package com.ucr.distribuidos.carpooling.Model;
...
public class PassengerAgent extends Agent {
    ...
    public PassengerAgent(String origin, String destiny, String departTime, String arrivalTime) {
        _origin = origin;
        _destiny = destiny;
...
//
        ...
        addBehaviour(new TickerBehaviour(PassengerAgent.this, 6000) {

            protected void onTick() {
//                _origin = origin;
//                _arrivalTime = arrivalTime;
//                _destiny = destiny;
                LogUtils.LOGD("PASSENGER AGENT", "[" + getAID().getName() + "]: Intentando apartar campo para " + _destiny + "(" + _arrivalTime + ")");
...
//        this.askForRide(this._origin, this._destiny, this._arrivalTime);
//    }
